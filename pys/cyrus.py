...
def lists_project(dTitle, sPath, flag):
    ...
    print("\n-------------------------------------------------------")
    if flag == 0:
        print("\x1b[0;35m [33] - Распаковать[zip-архив]\n [77] - Настройки программы\n [44] - Удалить\n [66] - Скачать\n [88] - Выйти  \x1b[0m\n")
...
def quiet():
    V.JM = input('> Отключить  назойливые вопросы и автоматически согласиться на все действия? [0/1]: ') == '1'
